package com.sk.skala.myspringapp.aspect;
...
public class TracingAspect {
    ...
    @Pointcut("execution(* com.sk.skala.myspringapp.controller.*.*(..))")
    ...
    public Object trace(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // log.info("→ [ENTER] {}.{}() with arguments: {}", className, methodName,
        // argString);
        ...
        try {
            ...
            message = String.format("← [EXIT] %s.%s() returned: %s (executed in %dms)", className, methodName,
                    resultString, executionTime);
